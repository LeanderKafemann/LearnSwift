...
// Charaktere und Plattformen platzieren.
...
let blu_ = Character(name: .blu)
world.place(blu_, atColumn: 5, row: 1)

// Arrays aus bestehenden Charakteren erstellen.
...
backLock.movePlatforms(up: true, numberOfTimes: 15)
